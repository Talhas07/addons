...
class Repair(models.Model):
    ...
    product_id = fields.Many2one(
        ...
        domain="[('is_storable', '=', True), '|', ('company_id', '=', company_id), ('company_id', '=', False)]",
    ...
    product_uom = fields.Many2one(
        ...
        readonly=False, required=True, domain="[('category_id', '=', product_uom_category_id)]")
    product_uom_category_id = fields.Many2one(related='product_id.uom_id.category_id')
    product_bar_code = fields.Char('Product Barcode', related='product_id.barcode', readonly=True, store=False)
    ...
    location_id = fields.Many2one(
        ...
        index=True, readonly=False, required=True, check_company=True,
    ...
    invoice_method = fields.Selection([
        ...
        default='none', index=True, readonly=False, required=True,
